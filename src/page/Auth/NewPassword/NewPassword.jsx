...
const NewPassword = () => {
  ...
  return (
    <div className="w-full   h-full md:h-screen md:flex justify-around ">
      ...
      /> */}
      <div className="w-full max-w-7xl mx-auto border-shadow items-center rounded-md h-[70%] md:my-28 grid grid-cols-1 md:grid-cols-2 place-content-center px-5 py-10 gap-8 bg-white md:mx-10">
        <div>
          <img
        ...
        <div className="mt-16">
          <div className="mb-5">
            ...
            <h1 className="font-semibold mt-5 text-xl flex items-center gap-2">
              <Link to="/auth/login">
                <IoIosArrowBack />
              </Link>
              Update Password
          ...
          >
            ...
            <Form.Item>
              <button className="w-full bg-[#00adb5] text-xl font-semibold text-white rounded-md py-2" loading={isLoading} border >
                Update Password
              </button>
            </Form.Item>
          </Form>
